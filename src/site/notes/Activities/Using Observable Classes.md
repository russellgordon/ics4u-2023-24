...
In tomorow's lesson, you will learn how easy the new `SwiftData` framework makes it to persist the data to a database – much more easily than with the `Blackbird` framework we used last year.
